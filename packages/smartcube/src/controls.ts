...
const BINDING_DETAILS: Record<CubeCommand, Omit<CommandBinding, "command">> = {
  down: {
    description: "Turn the red face clockwise to move downward.",
    face: "R",
  ...
  left: {
    description: "Turn the white face counterclockwise to move left.",
    face: "U",
  ...
  right: {
    description: "Turn the white face clockwise to move right.",
    face: "U",
    faceColor: FACE_COLORS.U,
    faceLabel: FACE_LABELS.U,
    move: "U",
  ...
  up: {
    description: "Turn the red face counterclockwise to move upward.",
    face: "R",
    faceColor: FACE_COLORS.R,
    faceLabel: FACE_LABELS.R,
    move: "R'",
